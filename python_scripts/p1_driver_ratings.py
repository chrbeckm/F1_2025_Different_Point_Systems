...
# 1 plot for each of Matt, Tommy, Audience adding up ratings
...
# 1 plot for each of Matt, Tommy, Audience averaging the ratings
...
# Count nr of P1 mentions for Matt and Tommy
